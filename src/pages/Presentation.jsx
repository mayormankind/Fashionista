  ...
  return (
    <div className='flex w-full h-full bg-lightBrown relative font-nunito'>
        <div className="flex flex-col w-full my-auto min-h-screen md:flex-row" >
            <div className="flex flex-col text-lightGray gap-5 w-full text-[17px] my-auto py-20 px-5 md:px-14 md:py-0 md:w-1/2">
                <div className="">
                ...
                <button className="bg-[#383838] hover:bg-[#292929] text-white p-4 font-semibold w-2/5 text-[17px] md:mt-6 md:w-2/6 ">Shop +</button>              
            </div>
            <div className="w-full h-full md:w-1/2">
                <img src="assets/998.png" alt="" className='w-full h-full'/>
            </div>
        </div>      
    </div>
  )
